...
def perform_interpretable_axis(file_list, trial_start=-15, trial_stop=0):

    save_directory = "/home/matthew/Pictures/interpretable_axes_plots/"

    for timepoint in range(-15, 0):
        ...
        for matlab_file_location in file_list:
            ...
            visual_context_vis_2_onsets = data_object.vis2_frames[0]
            odour_context_vis_1_onsets = data_object.irrel_vis1_frames[0]
            odour_context_vis_2_onsets = data_object.irrel_vis2_frames[0]
            ...
            all_vis_1_trial_tensor = create_trial_tensor(delta_f_matrix, visual_context_vis_1_onsets, trial_start, trial_stop)
            all_vis_2_trial_tensor = create_trial_tensor(delta_f_matrix, visual_context_vis_2_onsets, trial_start, trial_stop)
