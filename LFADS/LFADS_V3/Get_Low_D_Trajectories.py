...
def get_trajectories(model, number_of_sessions, condition_1_data_list, condition_2_data_list):
    ...
    print("PRojected Shape", np.shape(projected))


    return projected, colour_list
...
# Load Model Weights
weights_file = "/home/matthew/Documents/Github_Code/Population_Analysis/LFADS/LFADS_V3/Model_Weights/36900_Model_weights"
model.load_weights(weights_file)

# Get Low D Trajectoreis
low_d_trajectory_list, colour_list = get_trajectories(model, number_of_sessions, condition_1_data_list, condition_2_data_list)

# Save Trajectories
save_directory = "/home/matthew/Documents/Github_Code/Population_Analysis/LFADS/LFADS_V3/Low_D_Trajectories"
np.save(os.path.join(save_directory, "Low_D_Trajectories.npy"), low_d_trajectory_list)
np.save(os.path.join(save_directory, "Colour_List.npy"), colour_list)
